...
namespace APICodere.Mappings
{
    public class MappingProfile: Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Show.Networkclass, NetworkDto>()
                .ForMember(dest => dest.OfficialSite, opt => opt.MapFrom(src => src.OfficialSite ?? string.Empty));
            CreateMap<Show.Externalsclass, ExternalsDto>()
                .ForMember(dest => dest.Imdb, opt => opt.MapFrom(src => src.Imdb ?? string.Empty)); ;
            CreateMap<Show.Imageclass, ImageDto>();
            CreateMap<Show.Linkclass, LinkDto>()
